 ...
 * Now accepts a custom title (as requested).
 *
 * @param {string} title         - Announcement title (e.g. "Server Update")
 * @param {string} description   - Announcement body text
 * @param {import('discord.js').Guild} guild
 * @param {import('discord.js').User} author
 * @returns {EmbedBuilder}
 */
export function announcementEmbed(title, description, guild, author) {
